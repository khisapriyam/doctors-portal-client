...
const Sidebar = () => {
    ...
    return (
        <div className="sidebar d-flex flex-column justify-content-between col-md-12 py-5 px-4" style={{height:"100vh"}}>
            <ul className="list-unstyled">
                ...
                <li>
                    <Link to="/appointment" className="text-white">
                        <FontAwesomeIcon icon={faCalendar} /> <span>Get An Appointment</span> 
                    </Link>
                </li>
                <li>
            ...
            <div>
                <Link to="/" className="text-white"><FontAwesomeIcon icon={faSignOutAlt} /><Button onClick={() =>setLoggedInUser({})}><span>Logout</span></Button> </Link>
            </div>
        </div>
    );
};
